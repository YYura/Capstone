...
export default {
  ...
  methods: {
    buyCartLink () {
      window.location.href = 'http://localhost:8080/cart/buy'
    },
    shareCartLink () {
      window.location.href = 'http://localhost:8080/cart/share'
    },
    reservationCartLink () {
      window.location.href = 'http://localhost:8080/cart/reservation'
    }
